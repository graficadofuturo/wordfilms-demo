...
export const AnimatedBackground: React.FC<{ isVisible?: boolean }> = ({ isVisible = true }) => {
  ...
  const blobs = [
    {
      ...
      color: 'bg-white/20 md:bg-white/15',
      top: '-5%',
      left: '10%',
    ...
    },
    {
      ...
      color: 'bg-zinc-500/20 md:bg-zinc-500/15',
      top: '40%',
      left: '-10%',
      initial: { x: '0%', y: '0%', scale: 1 },
      animate: {
    ...
    },
    {
      ...
      color: 'bg-zinc-700/20 md:bg-zinc-700/30',
      top: '70%',
      left: '40%',
      initial: { x: '0%', y: '0%', scale: 1 },
      animate: {
    ...
    },
    {
      id: 11,
      size: 'w-[110vw] h-[110vw] md:w-[55vw] md:h-[55vw]',
      color: 'bg-zinc-200/20 md:bg-zinc-200/15',
      top: '65%',
      left: '-15%',
      initial: { x: '0%', y: '0%', scale: 1 },
      animate: {
    ...
    },
    {
      id: 7,
      size: 'w-[110vw] h-[110vw] md:w-[55vw] md:h-[55vw]',
      color: 'bg-zinc-600/20 md:bg-zinc-600/25',
      top: '95%',
      left: '50%',
      initial: { x: '0%', y: '0%', scale: 1 },
      animate: {
    ...
    },
    {
      id: 9,
      size: 'w-[100vw] h-[100vw] md:w-[50vw] md:h-[50vw]',
      color: 'bg-zinc-800/20 md:bg-zinc-800/40',
      top: '125%',
      left: '60%',
      initial: { x: '0%', y: '0%', scale: 1 },
      animate: {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute inset-0 blur-[40px] opacity-100 md:opacity-80"
        style={{
